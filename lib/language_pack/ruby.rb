  ...
  def build_bundler
    instrument 'ruby.build_bundler' do
      log("bundle") do
        ...
        bundle_bin     = "bundle"
        bundle_command = "#{bundle_bin} install --with-opencv-dir=/app/vendor/opencv/lib/pkgconfig --without #{bundle_without} --path vendor/bundle --binstubs #{bundler_binstubs_path}"
        bundle_command << " -j4"
